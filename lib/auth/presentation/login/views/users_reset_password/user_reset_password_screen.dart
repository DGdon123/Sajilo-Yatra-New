...
import 'package:sajilo_yatra/auth/presentation/login/controllers/reset_password_controllers/user_reset_password_controller.dart';
...
import '../../../../data/models/reset_password_models/user_reset_password_request.dart';
import '../../controllers/login_controllers/auth_state_helper.dart';
import '../main_login_screen.dart';

class Reset_Password extends ConsumerStatefulWidget {
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyHelloState();
}

class _MyHelloState extends ConsumerState<Reset_Password> {
  ...
  appLogin() async {
    ResetPasswordRequestModel resetPasswordRequestModel =
        ResetPasswordRequestModel(password: passwordController.text);
    if (forgotSignKey.currentState!.validate()) {
      ref.read(resetpasswordloadingProvider.notifier).update((state) => true);
      await ref.read(resetpasswordControllerProvider.notifier).reset_password(
          context: context,
          resetPasswordRequestModel: resetPasswordRequestModel);
    }
