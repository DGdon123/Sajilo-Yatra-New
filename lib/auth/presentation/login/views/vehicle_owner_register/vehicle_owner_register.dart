...
import '../../../../data/models/register_models/vehicle_owner_request_model.dart';
import '../../controllers/login_controllers/auth_state_helper.dart';
import '../../controllers/register_controllers/vehicle_owner_register_controller.dart';
import '../main_login_screen.dart';

class VRegister extends ConsumerStatefulWidget {
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyHelloState();
}

class _MyHelloState extends ConsumerState<VRegister> {
  ...
  TextEditingController vehNumController = TextEditingController();
  TextEditingController vehTypeController = TextEditingController();
  TextEditingController vehFacController = TextEditingController();
  TextEditingController vehSeatController = TextEditingController();
  TextEditingController locationController = TextEditingController();
  TextEditingController dobController = TextEditingController();
  final GlobalKey<FormState> vehicleregisterSignKey = GlobalKey<FormState>();
  ...
  appLogin() async {
    VehicleOwnerRegisterRequestModel registerRequestModel =
        VehicleOwnerRegisterRequestModel(
      ...
      vehicleName: vehNameController.text,
      vehicleNumber: vehNumController.text,
      vehicleSeat: seat,
      vehicleType: vehTypeController.text,
    );
    if (vehicleregisterSignKey.currentState!.validate()) {
      ref.read(loginSignUPloadingProvider.notifier).update((state) => true);
      await ref.read(vehicleownerregisterControllerProvider.notifier).vregister(
          context: context,
          vehicleOwnerRegisterRequestModel: registerRequestModel);
    }
                ...
                children: <Widget>[
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: CustomAppForm(isSuffixIconrequired: false,
                        readOnly: false,
                        textEditingController: vehNameController,
                        isPrefixIconrequired: true,
                        prefixIcon: CupertinoIcons.car_fill,
                        lable: AppConst.kvehicleName,
                        validator: (input) =>
                            input!.isVehicleNameValidate(input),
                      ),
                    ),
                  ),
                  SizedBox(height: AppDimensions.paddingSMALL),
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: CustomAppForm(isSuffixIconrequired: false,
                        readOnly: true,
                        textEditingController: vehTypeController,
                        isPrefixIconrequired: true,
                        prefixIcon: CupertinoIcons.car_fill,
                        lable: AppConst.kvehicleType,
                        validator: (input) =>
                                ...
                                content: Container(
                                  ...
                                  child: DropdownButtonFormField<String>(
                                    ...
                                    onChanged: (String? newValue) {
                                      setState(() {
                                        veh = newValue!;
                                        vehTypeController.text = newValue;
                                      });
                                      Navigator.of(context).pop(newValue);
                                    },
                                    ...
                                    selectedItemBuilder:
                                        (BuildContext context) {
                                      return vehicle.map<Widget>((String item) {
                                        return Padding(
                                          padding: const EdgeInsets.only(
                                              left:
                                                  6), // Add left padding for selected item
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: CustomAppForm(isSuffixIconrequired: false,
                        readOnly: false,
                        textEditingController: vehNumController,
                        isPrefixIconrequired: true,
                        prefixIcon: CupertinoIcons.car_fill,
                        lable: AppConst.kvehicleNumber,
                        validator: (input) =>
                            input!.isVehicleNumberValidate(input),
                      ),
                    ),
                  ),
                  SizedBox(height: AppDimensions.paddingSMALL),
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: CustomAppForm(isSuffixIconrequired: false,
                        readOnly: false,
                        keyboardType: TextInputType.number,
                        textEditingController: vehSeatController,
                        isPrefixIconrequired: true,
                        prefixIcon: Icons.event_seat_rounded,
                        lable: AppConst.kvehicleSeat,
                        validator: (input) =>
                            input!.isVehicleSeatsValidate(input),
                        onChanged: (p0) {
                          seat = int.parse(p0);
                        },
                      ),
