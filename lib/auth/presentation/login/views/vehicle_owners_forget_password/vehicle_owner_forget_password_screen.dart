...
import '../../controllers/forget_password_controllers/vehicle_owner_forget_password_controller.dart';
import '../../controllers/login_controllers/auth_state_helper.dart';

class VehicleOwner_Forgot_Password extends ConsumerStatefulWidget {
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyHelloState();
}

class _MyHelloState extends ConsumerState<VehicleOwner_Forgot_Password> {
  ...
  appLogin() async {
    VehicleOwnerForgotPasswordRequestModel vehicleforgotPasswordRequestModel =
    ...
    if (forgotSignKey.currentState!.validate()) {
      ...
      await ref
          .read(vehicleforgetpasswordControllerProvider.notifier)
          .vehicle_forgot_password(
              context: context,
              vehicleforgotPasswordRequestModel:
                  vehicleforgotPasswordRequestModel);
    }
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: CustomAppForm(
                        ...
                        validator: (input) => input!.isValidEmail(input), isSuffixIconrequired: false,
                      ),
                    ),
                  ),
