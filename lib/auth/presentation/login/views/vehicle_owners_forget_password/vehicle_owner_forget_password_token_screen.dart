...
import '../vehicle_owner_reset/vehicle_owner_reset_password_screen.dart';

class Vehicle_Forgot_Password_Token extends ConsumerStatefulWidget {
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyHelloState();
}

class _MyHelloState extends ConsumerState<Vehicle_Forgot_Password_Token> {
  ...
  appLogin() async {
    ApiConst.vehicle_email = emailController.text.toString();
    normalNav(context, VehicleOwner_Reset_Password());
  }
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: CustomAppForm(
                        ...
                        validator: (input) => input!.isTokenValidate(input), isSuffixIconrequired: false,
                      ),
                    ),
                  ),
