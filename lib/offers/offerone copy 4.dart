...
class OfferFive extends StatefulWidget {
  const OfferFive({Key? key}) : super(key: key);

  @override
  State<OfferFive> createState() => _OfferFiveState();
}

class _OfferFiveState extends State<OfferFive> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text(
                        "Save Rs: 1000 on 1 hour 30 Min Ride",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            ...
                            Container(
                              child: const Column(
                                ...
                                children: [
                                  CustomListing(
                                      text:
                                          'Apply Coupon code HGHG7 on 1 hour 30 Min \nRide and save Rs.900 on HGHG7 vehicle services'),
                                  SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        CustomPrimaryButton(
                          ...
                          onPressed: () {
                            String code =
                                "HGHG7"; // replace with the actual code string
