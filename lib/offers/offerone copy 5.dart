...
class OfferSix extends StatefulWidget {
  ...
  @override
  State<OfferSix> createState() => _OfferSixState();
}

class _OfferSixState extends State<OfferSix> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text(
                        "Save Rs: 70 on Every Ticket/Ride",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            ...
                            Container(
                              child: const Column(
                                ...
                                children: [
                                  CustomListing(
                                    text:
                                        'Apply Coupon code JHVJ34 on Every Ticket/\nRide and save Rs.900 on JHVJ34 vehicle services',
                                  ),
                                  SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        CustomPrimaryButton(
                          ...
                          onPressed: () {
                            String code =
                                "JHVJ34"; // replace with the actual code string
