...
class RentalLeavingScreen extends ConsumerStatefulWidget {
  const RentalLeavingScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyHelloState();
}

class _MyHelloState extends ConsumerState<RentalLeavingScreen> {
                        ...
                        child: TextFormField(
                          ...
                          onEditingComplete: () async {
                            ...
                            await prefs.setString(
                                'rentalleaving', _textEditingController.text);
