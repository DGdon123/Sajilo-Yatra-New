...
import 'package:sajilo_yatra/users_dashboard/presentation/views/dashboard_screen.dart';
import 'package:sajilo_yatra/users_ride/presentation/views/set_home_location.dart';
import 'package:sajilo_yatra/users_ride/presentation/views/set_location.dart';
...
class _MyHelloState extends ConsumerState<HomeAddress> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
              ...
              onEditingComplete: () {
                setState(() {
                  ...
                  SharedPreferences.getInstance().then((prefs) {
                    prefs.setString(
                        'home1', _textEditingController.text.toString());
                  });
                  SharedPreferences.getInstance().then((prefs) {
                    prefs.setDouble(
                        'lat1', double.parse(_textEditingController2.text));
                  });
                  SharedPreferences.getInstance().then((prefs) {
                    prefs.setDouble(
                        'long1', double.parse(_textEditingController3.text));
                  });
          ...
          InkWell(
            onTap: () {
              normalNav(context, const SetHomeLocation());
            },
            child: SizedBox(
              height: 10.h,
              child: Row(
