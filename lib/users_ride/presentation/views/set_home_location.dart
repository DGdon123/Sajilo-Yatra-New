...
class SetHomeLocation extends ConsumerStatefulWidget {
...
class _MyHelloState extends ConsumerState<SetHomeLocation> {
    ...
    return Scaffold(
      ...
      body: isLocationLoaded
          ? FlutterLocationPicker(
              selectLocationButtonText: AppConst.kConfirmHome,
              ...
              onPicked: (pickedData) {
                SharedPreferences.getInstance().then((prefs) {
                  prefs.setString('home', pickedData.address.toString());
                });
                SharedPreferences.getInstance().then((prefs) {
                  prefs.setDouble('latitude1',
                      double.parse(pickedData.latLong.latitude.toString()));
                });
                SharedPreferences.getInstance().then((prefs) {
                  prefs.setDouble('longitude1',
