...
import 'vehicle_owner_ticket_screen.dart';

class VehicleOwnerGoingScreen extends ConsumerStatefulWidget {
  const VehicleOwnerGoingScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyHelloState();
}

class _MyHelloState extends ConsumerState<VehicleOwnerGoingScreen> {
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onEditingComplete: () async {
                            ...
                            await prefs.setString('vehicleownergoing',
                                _textEditingController.text);
                            normalNav(context, const VehicleOwnerTicketScreen());
                          },
                        ),
                      ),
                    ],
