...
class VehicleOwnerLeavingScreen extends ConsumerStatefulWidget {
  const VehicleOwnerLeavingScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyHelloState();
}

class _MyHelloState extends ConsumerState<VehicleOwnerLeavingScreen> {
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onEditingComplete: () async {
                            ...
                            await prefs.setString('vehicleownerleaving',
                                _textEditingController.text);
                            normalNav(
